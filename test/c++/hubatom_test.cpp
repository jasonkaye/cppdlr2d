 ...
 */
void hubatom_test_driver(double beta, double u, double lambda, double eps, int niomtst, int nbos_tst, bool compressgrid, bool compressbasis,
                         double tol) {
...
TEST(hubatom, compress_if) {
  ...
  hubatom_test_driver(beta, u, lambda, eps, niomtst, nbos_tst, compressgrid, compressbasis, tol);
}
